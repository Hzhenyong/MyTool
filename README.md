...
[![Build Status](https://github.com/wenjianzhang/go-admin/workflows/build/badge.svg)](https://github.com/Hzhenyong/go-admin)
[![Release](https://img.shields.io/github/release/go-admin-team/go-admin.svg?style=flat-square)](https://github.com/Hzhenyong/go-admin/releases)
[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/Hzhenyong/go-admin)

English | [简体中文](https://github.com/Hzhenyong/go-admin/blob/master/README.Zh-cn.md)
...
[Front-end project](https://github.com/Hzhenyong/go-admin-ui)
...
```bash
# Get backend code
git clone https://github.com/Hzhenyong/go-admin.git

# Get the front-end code
git clone https://github.com/Hzhenyong/go-admin-ui.git
...
[MIT](https://github.com/Hzhenyong/go-admin/blob/master/LICENSE.md)
